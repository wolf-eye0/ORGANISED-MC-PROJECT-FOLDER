...
**Document status:** Operational baseline, revision 1.0  
...
|---|---|---|
| **Nihad P C** | Integration, project management, architecture/configuration, interfaces, risk, evidence integrity, gates | Keeps Sreehari and Amith able to reconstruct current integration; never becomes the only holder of credentials/configuration knowledge. |
| **Sreehari K** | Firmware, acquisition, DSP, USB schema, analysis, splits, metrics | Nihad reviews releases/parameters; Sreehari trains a backup to flash, capture and reproduce analysis. |
| **Amith Krishna Das** | Procurement, power/wiring, mechanical rig, mounts, safety, component acceptance | Nihad reviews interfaces; Sreehari reviews pin/signal assumptions; safety tests always observed. |
| **Sreeprada K S** | Inventory, operator checklists, repeated runs, labels, photographs, procedural conformance | **Lab Assistant / Technical Observer.** Technical changes are proposed, never independently applied to wiring, thresholds, firmware releases or safety features. |
| **Archa Pramod** | Minutes, controlled documents, teacher communications, evidence/source index, demo/report assembly | **Lab Assistant / Technical Observer.** Technical claims require review by Nihad, Sreehari or Amith. |
...
**People:** Owner Nihad; reviewer Sreehari; backup Amith; Lab Assistant/Observer Archa; secondary observer/learner Sreeprada.
...
3. Amith gives the motor-rig briefing: isolation, restraint, guard, captive eccentric, eye protection, power-off adjustment, emergency disconnect and stop conditions.
...
6. Install or schedule Arduino IDE, Espressif Arduino core, Git and serial capture. Do not call a version “frozen” until a flash/capture smoke test succeeds on two computers or the documented fallback computer.
7. Assign every role plus backup. Nihad hands Sreehari/Amith the current architecture/configuration location.
...
**People:** Owner Amith; reviewer Nihad; backup Sreehari; Lab Assistant/Observer Sreeprada; Archa records source/revision history.
...
**People:** Owner Amith; reviewer Nihad; backup Sreehari; Lab Assistant/Observer Sreeprada; Archa indexes photographs/invoices.
...
**People:** Owner Sreehari; reviewer Nihad; backup Amith; Lab Assistant/Observer Archa; Sreeprada follows the operator checklist.
...
**People:** Owner Sreehari; reviewer Nihad; backup Amith; Lab Assistant/Observer Sreeprada; Archa indexes plots/evidence.
...
**People:** Owner Amith; reviewer Nihad for integration and a second technical/safety reviewer as available; backup Sreehari; Lab Assistant/Observer Sreeprada; Archa photographs and indexes.
...
**People:** Owner Sreehari for data; reviewer Nihad; hardware co-owner/backup Amith; Lab Assistant/Operator Sreeprada under supervision; Archa indexes evidence.
...
**People:** Owner Amith for physical condition; data co-owner Sreehari; reviewer Nihad; backup Sreehari/Amith reciprocally; Lab Assistant/Operator Sreeprada under supervision; Archa indexes.
...
**People:** Owner Sreehari; reviewer Nihad; backup Amith for end-to-end reproduction; Lab Assistant/Observer Sreeprada; Archa reviews wording/demo visibility.
...
**People:** Owner Sreehari; reviewer Nihad; backup Amith; Lab Assistant/Observer Archa; Sreeprada operates only from the script.
...
**People:** Test operator Sreeprada under supervision; technical owner Sreehari; configuration controller/reviewer Nihad; hardware/safety co-reviewer Amith; Lab Assistant/Observer Archa records chronology. Nihad is not the sole approver of this gate.
...
**People:** Owner Archa; technical reviewer Nihad; backup Sreehari; hardware/safety reviewer Amith; Lab Assistant/Observer Sreeprada is trained operator.
