...
### Upload-limited package note

For this Gemini/Qwen research lane, the ten canonical project documents are
represented by nine evidence attachments because canonical documents 7 and 8
are stored verbatim inside:

`07-08_Validated_Downselection_Evidence_Bundle.md`

The combined attachment contains:

- `07_Concept_Evidence_Matrix.md`; and
- `08_Uncertainty_and_Test_Register.md`.

Treat them as two separate logical sources with their original authority
level.

The transport bundle is not a synthesis, replacement authority, or modified
technical document.

Do not report documents 7 or 8 as missing merely because they share one
attachment.

The complete package therefore contains ten uploaded attachments:

- one governing instruction file; and
- nine evidence attachments representing all ten canonical project
  documents.

Before substantive research, inventory the ten uploaded attachments and
confirm that they represent the governing instruction and all ten canonical
project documents. Canonical documents 7 and 8 are enclosed verbatim as
separate logical sources within
`07-08_Validated_Downselection_Evidence_Bundle.md`. Do not report either as
missing merely because they share one transport attachment. Confirm that both
internal documents are readable. Do not substitute Decision Register v1.1.
